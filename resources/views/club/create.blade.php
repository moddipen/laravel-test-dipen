...
@section('header_styles')
    ...
    <link href="{{ asset('assets/vendors/datetimepicker/css/bootstrap-datetimepicker.min.css') }}"
          rel="stylesheet">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-lg-12 my-3">
                <div class="card panel-primary">
                    ...
                    <div class="card-body">
                        <!--main content-->
                        <form id="commentForm" action="{{ route('clubs.store') }}"
...
{{--                                </ul>--}}
                                <div class="tab-content">
                                    <div>
                                        <div class="form-group {{ $errors->first('club_name', 'has-error') }}">
                                            <div class="row">
                                                <label for="club_name" class="col-sm-2 control-label">Name *</label>
                                                <div class="col-sm-10">
                                                    <input id="club_name" name="club_name" type="text"
                                                           placeholder="Club name"
                                                           class="form-control required"
                                                           value="{!! old('club_name') !!}"/>
                                                    <span class="help-block">{{ $errors->first('club_name', ':message') }}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <br>

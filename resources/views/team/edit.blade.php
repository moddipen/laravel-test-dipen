        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-lg-12 my-3">
                <div class="card panel-primary">
                    ...
                    <div class="card-body">
                        <!--main content-->
                        <form id="commentForm" action="{{ route('teams.update', $team->id) }}"
                                    ...
                                    <div>
                                        <div class="form-group {{ $errors->first('name', 'has-error') }}">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input id="name" name="name" type="text" placeholder="Name" class="form-control required" value="{!! old('name') ?? $team->name !!}"/>

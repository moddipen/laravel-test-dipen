            ...
            <div class="col-12">
                <div class="card panel-success ">
                    <div class="card-heading">
                        ...
                        @if(Auth::user()->hasAnyPermission(['Team create']))
                            <div class="pull-right">
                                <a href="{{route('teams.create')}}" type="button" class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="left"><i class="fa fa-plus"></i>Add New</a>
                            </div>
                        @endif
                    </div>
                    <div class="card-body">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="deleteLabel">Delete Team</h4>

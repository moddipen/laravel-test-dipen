...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Edit Player group</li>
        </ol>
    </section>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-lg-12 my-3">
                <div class="card panel-primary">
                    ...
                    <div class="card-body">
                        <!--main content-->
                        <form id="commentForm" action="{{ route('player-groups.update', $playerGroup->id) }}"
                                    ...
                                    <div>
                                        <div class="form-group {{ $errors->first('name', 'has-error') }}">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input id="name" name="name" type="text" placeholder="Name" class="form-control required" value="{{ old('name') ?? $playerGroup->name }}"/>
                                                ...
                                                <div class="col-sm-10">
                                                    <select id="select21" name="team" class="form-control select2">
                                                        ...
                                                        @foreach($teams as $team)
                                                            <option {{ $playerGroup->team_id == $team->id ? 'selected="selected"' : '' }} value="{{$team->id}}">{{$team->name}}</option>
                                                        @endforeach
                                                    </select>
